...
contract("BBSEBank", (accounts) => {
    ...
    describe("success", () => {
        ...
        it("should deposit correctly", async () => {
            ...
            ).to.be.above(0); // Use web3 to find the Ether balance of any account
        });
        ...
        it("should withdraw correctly", async () => {
            ...
            const oldEthBalance = Number(
                await web3.eth.getBalance(accounts[1])
            );
            await bbseBank.withdraw({
                from: accounts[1],
            });
            const newEthBalance = Number(
                await web3.eth.getBalance(accounts[1])
            );
    ...
    describe("failure", () => {
        it("should reject invalid yearly return rate", async () => {
            ...
            ); // Use this error message in your BBSEBank constructor
        });
        ...
        it("should reject account having multiple active deposit", async () => {
            ...
            ); // Use this error message in your deposit function
        });
